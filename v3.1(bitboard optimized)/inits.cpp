...
void start_inits() {
	...
	notBFile = (1ULL << B1) | (1ULL << B2) | (1ULL << B3) | (1ULL << B4)
				| (1ULL << B5) | (1ULL << B6) | (1ULL << B7) | (1ULL << B8);
	notBFile = ~notBFile;

	notCFile = (1ULL << C1) | (1ULL << C2) | (1ULL << C3) | (1ULL << C4)
				| (1ULL << C5) | (1ULL << C6) | (1ULL << C7) | (1ULL << C8);
	notCFile = ~notCFile;

	notDFile = (1ULL << D1) | (1ULL << D2) | (1ULL << D3) | (1ULL << D4)
				| (1ULL << D5) | (1ULL << D6) | (1ULL << D7) | (1ULL << D8);
	notDFile = ~notDFile;

	notEFile = (1ULL << E1) | (1ULL << E2) | (1ULL << E3) | (1ULL << E4)
				| (1ULL << E5) | (1ULL << E6) | (1ULL << E7) | (1ULL << E8);
	notEFile = ~notEFile;

	notFFile = (1ULL << F1) | (1ULL << F2) | (1ULL << F3) | (1ULL << F4)
				| (1ULL << F5) | (1ULL << F6) | (1ULL << F7) | (1ULL << F8);
	notFFile = ~notFFile;

	notGFile = (1ULL << G1) | (1ULL << G2) | (1ULL << G3) | (1ULL << G4)
